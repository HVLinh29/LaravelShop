								...
								<tr><td>
										...
										<form method="POST" action="{{url('/check-coupon')}}">
										  ...
										  <td>
											...
											<button type="submit" class="btn btn-danger check_out" name="redirect">Thanh toán VNPAY</a>
											</form>
											{{-- <form action="{{url('/momo-payment')}}" method="POST">
												@csrf
												<input type="hidden" name="total_momo" value="{{$total_after}}">
											<button type="submit" class="btn btn-default check_out" name="payUrl">Thanh toan MOMO</a>
											</form> --}}
										</td>
								</tr>
								@endif
